...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    Keyword = syntax_entry(palette.keyword, palette.none),
    ...
    TSKeywordReturn = syntax_entry("#30baac", palette.none, optional_italics),
    TSLabel = { link = "Orange" },
    ...
    ["@keyword"] = syntax_entry("#30baac", palette.none, optional_italics),
    ...
    ["@keyword.function"] = syntax_entry("#30baac", palette.none, optional_italics),
    ...
    ["@keyword.return"] = syntax_entry("#30baac", palette.none, optional_italics),
